<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CaseRegistration.aspx.cs" Inherits="LawDesk.Views.CaseRegistration" %>
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        <form id="ExampleForm">
                            <div>
                                <h4>Case Details<br>
                                    <small>Enter description of case here</small></h4>
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <asp:TextBox ID="txtCaseNumber" CssClass="form-control" required="required" placeholder="A unique identifier for this case" runat="server"></asp:TextBox>
                                        </div>
                                        <div class="col-md-3">
