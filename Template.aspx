<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Template.aspx.cs" Inherits="LawDesk.Template" %>
            ...
            <nav class="navbar topnavbar">
                ...
                <ul class="navbar-nav mr-auto flex-row">
                    <li class="nav-item">
                        ...
                        <a class="nav-link sidebar-toggle d-md-none" href="#" data-toggle-state="aside-toggled" data-no-persist="true"><em class="fas fa-bars"></em></a></li>
                    <!-- START User avatar toggle-->
                    <li class="nav-item d-none d-md-block">
                        <!-- Button used to collapse the left sidebar. Only visible on tablet and desktops-->
                        <a class="nav-link" id="user-block-toggle" href="#user-block" data-toggle="collapse"><em class="icon-user"></em></a></li>
                    ...
                    <ul class="sidebar-nav">
                        ...
                        <li class=" "><a href="#dashboard" title="Dashboard" data-toggle="collapse"> 
                            ...
                            <ul class="sidebar-nav sidebar-subnav collapse" id="dashboard">
                                ...
                                <li class=" "><a href="dashboard.html" title="Dashboard v1"><span>Dashboard</span></a></li> 
                            </ul>
                        </li> 
                      
                        <li class="nav-heading "><span data-localize="sidebar.heading.COMPONENTS">Components</span></li>
                          <li class=" "><a href="#clients" title="Layouts" data-toggle="collapse"><em class="icon-layers"></em><span>Clients</span></a>
                            <ul class="sidebar-nav sidebar-subnav collapse" id="clients">
                                <li class="sidebar-subnav-header">Layouts</li>
                                <li class=" "><a href="#"><span>Registration</span></a></li>
                                <li class=" "><a href="#"><span>Directory</span></a></li>
                                <li class=" "><a href="#"><span>Communication Channel</span></a></li>
                            </ul>
                        </li>
                        <li class=" "><a href="#matters" title="Layouts" data-toggle="collapse"><em class="icon-layers"></em><span>Matters</span></a>
                            <ul class="sidebar-nav sidebar-subnav collapse" id="matters">
                                <li class=" "><a href="#"><span>Cases</span></a></li>
                                <li class=" "><a href="#"><span>Contracts & Agreements</span></a></li>
                                <li class=" "><a href="#"><span>Court Hearings</span></a></li>                               
                             </ul>
                        </li>
                        
                        <li class=" "><a href="#tasks" title="tasks" data-toggle="collapse"><em class="icon-layers"></em><span>Tasks</span></a>
                            <ul class="sidebar-nav sidebar-subnav collapse" id="tasks">
                                <li class=" "><a href="#"><span>Appointments</span></a></li>
                                <li class=" "><a href="#"><span>Assignments</span></a></li>
                                <li class=" "><a href="#"><span>Milestones</span></a></li>   
                            </ul>
                        </li>  
                        <li class=" ">
                           <a href="#" title="Document Management"><em class="far fa-folder-open"></em><span>Document Management</span></a>
                        </li> 
                        <li class="nav-heading "><span data-localize="sidebar.heading.APPS">More</span></li>
                        <li class=" "><a href="#pages" title="Pages" data-toggle="collapse"><em class="icon-doc"></em><span data-localize="sidebar.nav.pages.Apps">Apps</span></a>
                            <ul class="sidebar-nav sidebar-subnav collapse" id="pages">
                                <li class="sidebar-subnav-header">Pages</li>
                               <li class=" "><a href="#"><span>Client App</span></a></li>
                                <li class=" "><a href="#"><span>Staff App</span></a></li>  
                            </ul>
                        </li>
                            ...
                            <div class="list-group">
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Juan Sims</strong></a><br>
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Maureen Jenkins</strong></a><br>
                                            <small class="text-muted">Designeer</small>
                                        </div>
                                        <div class="ml-auto"><span class="circle bg-success circle-lg"></span></div>
                                    </div>
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Billie Dunn</strong></a><br>
                                            <small class="text-muted">Designeer</small>
                                        </div>
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Tomothy Roberts</strong></a><br>
                                            <small class="text-muted">Designeer</small>
                                        </div>
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Lawrence Robinson</strong></a><br>
                                            <small class="text-muted">Designeer</small>
                                        </div>
                                        <div class="ml-auto"><span class="circle bg-warning circle-lg"></span></div>
                                    </div>
                                ...
                                <div class="list-group-item list-group-item-action border-0">
                                    <div class="media">
                                        ...
                                        <div class="media-body text-truncate">
                                            <a href="#"><strong>Tyrone Owens</strong></a><br>
                                            <small class="text-muted">Designeer</small>
                                        </div>
                                        <div class="ml-auto"><span class="circle bg-warning circle-lg"></span></div>
                                    </div>
